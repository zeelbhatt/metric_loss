...
if __name__ == "__main__":
    ...
    with torch.no_grad():
          for i in tqdm(range(len(kitti_dataset))):
                ...
                targets_array.append(targets.to(device='cpu'))
                predict_array.append(predictions.to(device='cpu'))


    np.save('/home/zbhatt1/contrast_vo/targets1.npy', np.array(targets_array))
    np.save('/home/zbhatt1/contrast_vo/predicts1.npy', np.array(predict_array))